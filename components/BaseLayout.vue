      ...
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8 m-0">
        <div>
          <saber-link to="/" class="flex items-center" >
            <span class="text-xl ml-2" :class="{ 'text-gray-800' : theme === 'theme-light', 'text-white' : theme === 'theme-dark'}">Andrea's Land</span>
          </saber-link>
        </div>
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="'#projects'" class="text-copy-primary hover:text-gray-600">Progetti</a>
            <saber-link v-else to="/#projects" class="text-copy-primary hover:text-gray-600">Progetti</saber-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#about" v-scroll-to="'#about'" class="text-copy-primary hover:text-gray-600">Su di me</a>
            <saber-link v-else to="/#about" class="text-copy-primary hover:text-gray-600">Su di me</saber-link>
          </li>
          <li>
            <saber-link to="/blog" class="text-copy-primary hover:text-gray-600">Portfolio</saber-link>
          </li>
        </ul>
      </nav>
    </header>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>Licenza <a href="https://creativecommons.org/licenses/by/4.0" target="_blank" class="text-white hover:text-gray-400">CC BY-SA 4.0</a></div>
        </div>
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:binelli.andrea@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/AndreaBinelli" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/enibrednow/" target="_blank" class="text-white hover:text-gray-400">
